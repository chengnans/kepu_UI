<template>
  <div class="box">
    ...
    文章来源：<el-input v-model="sources" placeholder="请输入文章来源"></el-input><br /><br />
    作者：<el-input v-model="author" placeholder="请输入作者"></el-input><br /><br />
      ...
      editorOption: {
        ...
        modules: {
          ImageExtend: {
            ...
            action: 'http://kepu.sd-smartagriculture.cn:7070/uploading',
            response: res => {
              // console.log(res)
              return 'http://kepu.sd-smartagriculture.cn:7070/' + res.data
            },
            headers: xhr => {
              // axios.defaults.withCredentials = true;
